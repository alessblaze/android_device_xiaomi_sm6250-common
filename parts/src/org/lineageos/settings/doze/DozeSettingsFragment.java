...
public class DozeSettingsFragment extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        PreferenceCategory pickupSensorCategory =
                (PreferenceCategory) getPreferenceScreen().findPreference(DozeUtils.CATEG_PICKUP_SENSOR);
        ...
        // If categories are missing in XML, avoid NPEs.
        if (gesturesCategory != null) gesturesCategory.setEnabled(dozeEnabled);
        if (pickupSensorCategory != null) pickupSensorCategory.setEnabled(dozeEnabled);
        if (proximitySensorCategory != null) proximitySensorCategory.setEnabled(dozeEnabled);
    }
